...
def main(args):
    ...
    t0 = time.time()
    data = load_data(args)
    print("=== load data: %f" % (time.time()-t0))
    ...
    print("=== static preprocessing: %f" % (time.time()-t0))
    ...
    for epoch in range(200):
        ...
        print("=== forward: %f" % (time.time()-t0))

        t0 = time.time()
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
        print("=== backward: %f" % (time.time()-t0))

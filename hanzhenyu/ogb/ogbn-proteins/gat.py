...
def train(args, model, dataloader, _labels, _train_idx, criterion, optimizer, _evaluator):
    ...
    return loss_sum / total, end_forward_time - begin_forward_time,end_backward_time - begin_backward_time
...
def run(args, graph, labels, train_idx, val_idx, test_idx, evaluator, n_running):
    ...
    for epoch in range(1, args.n_epochs + 1):
        ...
        loss,forwardt, backwardt = train(args, model, train_dataloader, labels, train_idx, criterion, optimizer, evaluator_wrapper)
...
if __name__ == "__main__":
    ...
    #     main()
    # p.export_chrome_trace('profile_gat-ogbn-proteins.json')
